...
############################# Stage 3 -> 006 to 010 #######################################
train_input_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Train/Input/006/"
train_output1_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Train/Output_target/010/"
train_gt_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Train/Input/010/"

test_input_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Test/Input/006/"
test_output1_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Test/Output_target/010/"
test_gt_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Test/Input/010/"

# Load the updated model state dictionary into the model
model_path = "/home/nano01/a/chand133/ThermAI/stage_target_006_to_010.pth"
...
def main():
    ...
    with torch.no_grad():
        for i, (input_image, output_image, source_image, target_image, input_image_filepath, output_image_filepath) in enumerate(train_loader2):
            ...
            plt.title('')
            # Save the figure
            output_path = f"{train_output1_image_paths_root}{prefix}_010.png"
        ...
        for i, (input_image, output_image, source_image, target_image, input_image_filepath, output_image_filepath) in enumerate(valid_loader2):
            ...
            # Save the figure
            output_path = f"{test_output1_image_paths_root}{prefix}_010.png"
            plt.savefig(output_path, bbox_inches='tight', pad_inches=0)
            if(i%10) == 0:
                print(output_path)
