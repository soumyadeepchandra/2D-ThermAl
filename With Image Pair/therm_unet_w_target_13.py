...
############################# Stage 1 -> 001 to 003 #######################################
train_input_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Train/Input/001/"
train_output1_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Train/Output_target/003/"
train_gt_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Train/Input/003/"

test_input_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Test/Input/001/"
test_output1_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Test/Output_target/003/"
test_gt_image_paths_root = F"/home/nano01/a/chand133/ThermAI/Dataset/Test/Input/003/"

# Load the updated model state dictionary into the model
model_path = "/home/nano01/a/chand133/ThermAI/stage_target_001_to_003.pth"
...
def main():
    ...
    with torch.no_grad():
        for i, (input_image, output_image, source_image, target_image, input_image_filepath, output_image_filepath) in enumerate(train_loader2):
            ...
            plt.title('')
            # Save the figure
            output_path = f"{train_output1_image_paths_root}{prefix}_003.png"
        ...
        for i, (input_image, output_image, source_image, target_image, input_image_filepath, output_image_filepath) in enumerate(valid_loader2):
            ...
            # Save the figure
            output_path = f"{test_output1_image_paths_root}{prefix}_003.png"
            plt.savefig(output_path, bbox_inches='tight', pad_inches=0)
            if(i%10) == 0:
                print(output_path)
